...
Сценарий: 02. Продажи/оплаты
	...
	* Проверка оплаты с бонусного счета
		...
		И пауза 1
		Если элемент "КнопкаВидыОплатПрименитьеСуммуСтрока_2x0" присутствует на форме Тогда
	...
	* Проверка смешанных оплат (наличные и ЛС)
		...
		Если элемент "КнопкаВидыОплатПрименитьеСуммуСтрока_1x0" присутствует на форме Тогда

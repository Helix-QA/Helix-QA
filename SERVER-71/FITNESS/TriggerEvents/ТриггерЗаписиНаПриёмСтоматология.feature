...
//Проверка триггера - Начало приема.
	...
	И таблица "Список" содержит строки по шаблону:
		...
		| 'Начало приема $$СлучайноеЧисло$$' | 'Поставить задачу сотруднику' | 'Запланировано'    | '*.*.* в 23:30:00' | '$$Пациент_2$$ ' | ''                          | 'Прием подтвержден, 23:30 - 23:59, 18 марта 2025 г. ' |
...
//Проверка триггера - Перенос даты и времени начала.
	...
	И таблица "Список" содержит строки по шаблону:
		...
		| 'Перенос даты и времени начала. $$СлучайноеЧисло$$' | 'Поставить задачу сотруднику' | 'Запланировано'  | '$$Пациент_2$$ ' | 'Прием подтвержден, 23:30 - 23:59, * * *. ' |
	И Я деактивировал триггер
//Проверка триггера - Смена статуса записи на прием сотрудником клиники.
	...
	И таблица "Список" содержит строки по шаблону:
		...
		| 'Смена статуса записи на прием сотрудником клиники $$СлучайноеЧисло$$' | 'Поставить задачу сотруднику' | 'Зарегистрировано' | '$$Пациент_2$$ ' | '$$Шаблон$$ (не выполнена)' | 'Прием подтвержден, 23:30 - 23:59, * * * г. ' |
	И Я деактивировал триггер
//Проверка триггера - Создание записи на прием.		
	...
	И таблица "Список" содержит строки по шаблону:
		...
		| 'Создание записи на прием $$СлучайноеЧисло$$' | 'Поставить задачу сотруднику' | 'Зарегистрировано' | '$$Пациент_2$$ ' | '$$Шаблон$$ (не выполнена)' | 'Прием подтвержден, 23:30 - 23:59, * * * г. ' |
	И Я деактивировал триггер

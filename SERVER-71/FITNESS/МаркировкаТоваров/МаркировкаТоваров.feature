...
//Добавление токена доступа в основную кассу организации.
	...
	И в таблице 'Список' я перехожу к строке:
		...
		| "Основная касса" | "Основная организация" |
	И в таблице 'Список' я выбираю текущую строку
...
//На стороне сервера ничего не надо,т.к там уже родной российский ip адрес).
	И я перезаполняю константу "РежимТестированияККТ" значением "Ложь"
	...
	И я перезаполняю константу "РежимТестированияККТ" значением "Истина"
...
//ВТОРАЯ ПРОДАЖА.
	...
	И я нажимаю на кнопку с именем 'ВыбратьКлиента'
	И в таблице '_ПодборНоменклатур' я выбираю текущую строку
	И в таблице 'РеализацияЗапасы' я активизирую поле с именем 'РеализацияЗапасыНомерСтроки'
	И в таблице 'РеализацияШапка' я активизирую поле с именем 'РеализацияШапкаНомер'

...
Создание элемента
	...
	И Я закрываю окно "Медицинская карта (создание)" // тут можно сохранить за одно и проверим из карточки клиента
	И я нажимаю на кнопку с именем 'КнопкаДобавитьРодственника' // добавим проверку создания родствиника
	Тогда открылось окно "1С:Предприятие"
	И я нажимаю на кнопку с именем 'Button0'
	...
	И Я закрываю окно "Карта (создание)" // можно сгенерить и сохранить

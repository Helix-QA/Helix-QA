...
if "%1"=="smoke"        call vrunner run --command "StartFeaturePlayer;DisableFeatureLoadOnOpenForm;QuietInstallVanessaExt;GenerateSmokeTest;VAParams=tools/VAParams.json" --execute "%2" --ibconnection /Slocalhost/%3 --db-user Admin

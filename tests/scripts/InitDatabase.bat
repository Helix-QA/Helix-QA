...
if "%1"=="remove" call vrunner remove --name %2 --drop-database --clear-database --db-user Админ --uccode "CICD"
if "%1"=="create" call vrunner create --db-server localhost --name %2 --dbms PostgreSQL --db-admin postgres --db-admin-pwd postgres --uccode "CICD"

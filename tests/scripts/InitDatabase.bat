...
if "%1"=="session_kill" call vrunner session kill --ras serverRAC --db %2 --db-user Админ --db-pwd "" --uccode tester
...
if "%1"=="session_unlock" call vrunner session unlock --ras serverRAC --db %2 --db-user Админ --db-pwd "" --uccode tester

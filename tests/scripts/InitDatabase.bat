...
if "%1"=="smoke"        call vrunner run --command "VAParams=%2\\tests\\tools\\VAParams.json;StartFeaturePlayer;GenerateSmokeTest;QuietInstallVanessaExtAndClose" --execute "%3" --ibconnection /Slocalhost/%4 --db-user Админ

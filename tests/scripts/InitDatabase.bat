...
if "%1"=="session_kill" call vrunner session kill --db %2 --db-user Админ --uccode tester
...
if "%1"=="unload"       call vrunner unload "D:\\cf\\1Cv8.cf" --ibconnection /Slocalhost/%2 --db-user Админ --uccode tester
if "%1"=="load"         call vrunner load --src "D:\\cf\\1Cv8.cf" --ibconnection /Slocalhost/%2 --db-user Админ --uccode tester
if "%1"=="updatedbRep"  call vrunner updatedb --ibconnection /Slocalhost/%2 --db-user Админ --uccode tester
if "%1"=="updatedb"     call vrunner updatedb --ibconnection /Slocalhost/%2 --db-user Админ --uccode tester
...
if "%1"=="smoke"        call vrunner run --command "StartFeaturePlayer;DisableFeatureLoadOnOpenForm;QuietInstallVanessaExt;GenerateSmokeTest;VAParams=D:\\jENKINS\\workspace\\VAutoTestAll\\tests\\tools\\VAParams.json" --execute "%2" --ibconnection /Slocalhost/%3 --db-user Admin

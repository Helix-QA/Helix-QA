...
Сценарий: Новый журнал записи
	...
	*Фильтр (Салон, Печать)
		...
		И я нажимаю на кнопку с именем 'ПечатьРасписанияВизитов_0'				
...
//		И в меню формы я выбираю 'Вечер'
		И я нажимаю на кнопку с именем 'ЗначениеФильтра_ВремяРаботы'
		И я перехожу к следующему реквизиту
		И я нажимаю на кнопку с именем 'ВремяРаботы_Утро'
		И я нажимаю на кнопку с именем 'ЗначениеФильтра_ВремяРаботы'
		И я перехожу к следующему реквизиту
		И я нажимаю на кнопку с именем 'ВремяРаботы_День'
		И я нажимаю на кнопку с именем 'ЗначениеФильтра_ВремяРаботы'
		И я перехожу к следующему реквизиту
		И я нажимаю на кнопку с именем 'ВремяРаботы_Вечер'				
	...
	*Проверка кнопки созданного визита в журнале записи
		...
		И я делаю клик по элементу клиента тестирования '17' 'Тип' UI Automation
	...
	*Проверка кнопки "Клиент ожидается"
		И я выбираю пункт контекстного меню с именем 'ПланКонтекстноеМенюСтатусОжидается' на элементе формы с именем 'Тело'

	*Проверка Кнопки "Устоновить нерабочее время"	
		И клик по координатам "800" "550"		

...
Сценарий: Загруза данных
	...
	И в таблице 'ИнтервалыВремени' из выпадающего списка с именем 'ИнтервалыВремениКонец' я выбираю точное значение "20:00"
...
Сценарий: Функция настройки журнала записи

...
Сценарий: Я создаю Клиента_2
	...
	Дано я запоминаю значение выражения '"Клиент" + Формат($Клиент_2$, "ЧГ=0")' в переменную "$$Клиент_2$$"
	Дано Я открываю основную форму справочника "Контрагенты"
	И в поле с именем 'Фамилия' я ввожу текст '$$Клиент_2$$'
	И я нажимаю на кнопку с именем 'Записать'
	И я сохраняю навигационную ссылку текущего окна в переменную "$$СсылкаКлиента_2$$"		
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
...
Сценарий: Я создаю Помещение_2
	...
	И в поле с именем 'Вместимость' я ввожу текст '15'
	И я изменяю флаг с именем 'ИспользоватьВРасписанииЗанятий'
	И я устанавливаю флаг с именем 'МониторингСвободногоПосещения'
...
Сценарий: Я проверяю ЗакрытиеСмены
	Если открылось окно "Внимание" Тогда
		И я нажимаю на кнопку с именем 'Button0'
		И я нажимаю на гиперссылку с именем 'ZОтчет_0'
		Если открылось окно "Зачет авансов *" Тогда
			Тогда я нажимаю на кнопку с именем 'ФормаКнопкаПровестиИЗакрыть'
		И я нажимаю на кнопку с именем 'ПодтвердитьЗакрытиеСмены'
...
Сценарий: Я создаю Поставщика
	И Я запоминаю случайное число в переменную "Поставщик"
	Дано я запоминаю значение выражения '"Поставщик" + Формат($Поставщик$, "ЧГ=0")' в переменную "$$Поставщик$$"
	И я перехожу по навигационной ссылке "e1cib/command/Справочник.Контрагенты.Команда.ОткрытьСписокПоставщиков"
...
Сценарий: Я создаю Товар_3
	И Я запоминаю случайное число в переменную "Товар"
	Дано я запоминаю значение выражения '"Товар" + Формат($Товар$, "ЧГ=0")' в переменную "$$Товар_3$$"
	Дано Я открываю основную форму справочника "Номенклатура"
	И из выпадающего списка с именем 'ТипНоменклатуры' я выбираю точное значение "Запас"	
	И в поле с именем 'Наименование' я ввожу текст "$$Товар_3$$"
	И я нажимаю на кнопку с именем 'КнопкаДобавитьЦену'
	И я нажимаю на кнопку с именем 'Button0'
	...
	И я нажимаю на кнопку с именем 'КнопкаДобавитьЦену'
	И я выбираю из списка 'Розничная цена '
	И в поле с именем '_Цена_2' я ввожу текст "131,00"			
	И я сохраняю навигационную ссылку текущего окна в переменную "$$СсылкаТовара_3$$"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

Сценарий: Я создаю Мастера_2
	И Я запоминаю случайное число в переменную "Мастер"
	Дано я запоминаю значение выражения '"Мастер_2" + Формат($Мастер$, "ЧГ=0")' в переменную "$$Мастер_2$$"
	Дано Я открываю основную форму справочника "Сотрудники"
	И в поле с именем 'Фамилия' я ввожу текст '$$Мастер_2$$'
	И из выпадающего списка с именем "РольПользователяВОсновнойИнформацие" я выбираю точное значение 'Мастер салона красоты'
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

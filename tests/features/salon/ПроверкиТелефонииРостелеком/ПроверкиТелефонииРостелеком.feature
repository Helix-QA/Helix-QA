...
Сценарий: Загрузка данных
	...
	И в таблице 'Список' я перехожу к строке:
		| 'Наименование' | 'Внутренний номер' |
		| 'Даниил'       | '300'              |
	И в таблице 'Список' я выбираю текущую строку
	И я меняю значение переключателя с именем 'ПривязанКСотрудникам' на "сотрудникам"
	...
	И в таблице 'ОбъектыПривязки' я завершаю редактирование строки
...
Сценарий: Проверяю статус звонка от клиента
	...
	*Проверка создания в истории вызовов
		...
		И в таблице 'Список' я перехожу к строке по шаблону:
			| 'От кого'                                | 'Дата звонка'   | 'Начало вызова' | 'Начало разговора' | 'Кому'          | 'Доб.' | 'Статус'   |
			| '$$ТелефонКлиента$$, $$ТелефонКлиента$$' | '$$ТекущДата$$' | '$$ТекВремя$$'  | '$$ТекВремя$$'     | 'admin, Админ ' | '300'  | 'Разговор' |
		И в таблице 'Список' я выбираю текущую строку
	...
	*Заполнения в карточке клиента поле "Комментарий"

...
Сценарий: Проверяю статус звонка от клиента
	...
	*Проверка создания в истории вызовов
		...
		И в таблице 'Список' я перехожу к строке по шаблону:
			...
			| '$$ТелефонКлиента$$, $$ТелефонКлиента$$' | '$$ТекущДата$$' | '$$ТекВремя$$'  | '$$ТекВремя$$'     | 'admin, Бухгалтер ' | '300'  | 'Разговор' | 'Нет'          |
...
Сценарий: Пропущенный
	...
	*Проверка создания в истории вызовов
		...
		И в таблице 'Список' я перехожу к строке по шаблону:
			...
			| '$$ТекущДата$$' | '$$ТекВремя1$$' | 'Новый клиент'   | '$$ТелефонКлиента2$$, $$ТелефонКлиента2$$' | 'admin, Бухгалтер ' | '300'  | 'Пропущен' |
		И в таблице 'Список' я выбираю текущую строку

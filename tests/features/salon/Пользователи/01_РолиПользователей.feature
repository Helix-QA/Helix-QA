...
Проверка пользователя ВсеПрава
	...
	И таблица 'Роли' стала равной:
		...
		| 'Добавление и изменение 1С:Номенклатуры'                                    | 'Да'      |
		...
		| 'Добавление и изменение документов корректировки долга'                     | 'Да'      |
		| 'Добавление и изменение документов корректировки долга франчайзи'           | 'Да'      |
		| 'Добавление и изменение документов перемещения'                             | 'Да'      |
		...
		| 'Добавление и изменение документов поступления'                             | 'Да'      |
		...
		| 'Добавление и изменение заявок'                                             | 'Да'      |
		...
		| 'Добавление и изменение маркетинговых акций'                                | 'Да'      |
		| 'Добавление и изменение настроек 1С:Бизнес-сеть'                            | 'Да'      |
		| 'Добавление и изменение настроек торговых предложений'                      | 'Да'      |
		| 'Добавление и изменение номенклатуры'                                       | 'Да'      |
		| 'Добавление и изменение обменов данными'                                    | 'Да'      |
		| 'Добавление и изменение операций по бонусным счетам'                        | 'Да'      |
		| 'Добавление и изменение планов обмена'                                      | 'Да'      |
		| 'Добавление и изменение подключаемого оборудования'                         | 'Да'      |
		| 'Добавление и изменение рассылок отчетов'                                   | 'Да'      |
		| 'Добавление и изменение сообщений'                                          | 'Да'      |
		| 'Добавление и изменение сотрудников'                                        | 'Да'      |
		| 'Добавление и изменение уведомлений о вводе в оборот МДЛП'                  | 'Да'      |
		| 'Добавление и изменение уведомлений о выбытии МДЛП'                         | 'Да'      |
		| 'Добавление и изменение уведомлений о выдаче в отделения МДЛП'              | 'Да'      |
		| 'Добавление и изменение уведомлений о передаче на уничтожение МДЛП'         | 'Да'      |
		| 'Добавление и изменение уведомлений о перемещении МДЛП'                     | 'Да'      |
		| 'Добавление и изменение уведомлений о повторном вводе в оборот МДЛП'        | 'Да'      |
		| 'Добавление и изменение уведомлений о приемке МДЛП'                         | 'Да'      |
		| 'Добавление и изменение уведомлений о факте уничтожения МДЛП'               | 'Да'      |
		| 'Добавление и изменение цен номенклатуры'                                   | 'Да'      |
		| 'Добавление и изменение электронных подписей и шифрование'                  | 'Да'      |
		| 'Добавление изменение сделок'                                               | 'Да'      |
		...
		| 'Получение платежной ссылки для Яндекс.Кассы'                               | 'Да'      |
		| 'Продление пакетов услуг'                                                   | 'Да'      |
		| 'Прослушивание телефонных звонков'                                          | 'Да'      |
		...
		| 'Чтение настроек 1С:Бизнес-сеть'                                            | 'Да'      |
		| 'Чтение настроек торговых предложений'                                      | 'Да'      |

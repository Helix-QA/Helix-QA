	...
	*Проверка работоспособности шапки
	...
	//Проверяю Услуги сотрудника
		...
		И в таблице '_ПодборНоменклатур' я перехожу к строке:
			| "Красотка" | "Номенклатура" |
			| "Нет"      | "Услуги "      |
		И в таблице '_ПодборНоменклатур' я снимаю флаг с именем 'СтруктурнаяЕдиница1'
	...
	//Начисление и удержание
		...
		И из выпадающего списка с именем 'СтрЕдиницаОтбор' я выбираю точное значение "Красотка "
		И я нажимаю на кнопку с именем 'Создать'

...
//Добавление кассы через универсальный редактор.
	...
	И в поле с именем 'Pattern' я ввожу текст "Сотрудники"
	И я нажимаю на кнопку с именем 'Find'
	И в таблице 'ДеревоОбъектов' я выбираю текущую строку
	И Я закрываю окно "Выбор сотрудника"
	И в поле с именем 'ВыбСсылка' я ввожу текст "Регистратура"
	И из выпадающего списка с именем 'ВыбСсылка' я выбираю точное значение "Регистратура (000000010)"
		
	И я перехожу к закладке с именем 'ТабличныеЧасти'
	И я перехожу к закладке с именем 'lyayЗакладкаТчДоступныеКассы'
	И в таблице 'lyayТчДоступныеКассы' я активизирую поле с именем 'lyayТчДоступныеКассыКасса'
	И в таблице 'lyayТчДоступныеКассы' я выбираю текущую строку
	И в таблице 'lyayТчДоступныеКассы' я нажимаю кнопку выбора у реквизита с именем 'lyayТчДоступныеКассыКасса'
	И в таблице 'Список' я выбираю текущую строку
	И в таблице 'lyayТчДоступныеКассы' я завершаю редактирование строки

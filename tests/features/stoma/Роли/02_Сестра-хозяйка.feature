...
Сценарий: Проверка на созданного пользователя.
	И Я проверяю пользователя "Сестра-хозяйка"

Сценарий: Сестра-хозяйка. Создание номенклатуры
Дано я подключаю TestClient "Сестра-хозяйка" логин "Сестра-хозяйка" пароль ""
...
Переменные
	...
	И я запоминаю случайное число в диапазоне от "100" до "999" в переменную "$Серия$"
	И Я запоминаю значение выражения 'Формат($Серия$, "ЧГ=0")' в переменную "$$Серия$$"
...
Создание элемента Товар
	...
	И Я закрываю окно "Упаковки для: \"$$Товар$$\""
...
Создание элемента Услуга
	...
	И я нажимаю на кнопку с именем 'Создать'
	И Я закрываю окно "Сегмент номенклатуры (создание)"
...
Создание элемента Подарочный сертификат
	...
	И я нажимаю на кнопку с именем 'Создать'
	И я нажимаю на кнопку с именем 'НовыйШтрихкод'
	И в поле с именем 'ПартииНоменклатуры' я ввожу текст "$$Серия$$"
	И я перехожу к следующему реквизиту
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
	И В текущем окне я нажимаю кнопку командного интерфейса "Упаковки"
	И В текущем окне я нажимаю кнопку командного интерфейса "Остатки "
...
Сценарий: Заказ поставщику, поступление. Опиходование. Инвентаризация
Заказ поставщику
	...
	И я нажимаю на кнопку с именем 'ЗапасыКнопкаДобавить'
	И в таблице 'Запасы' я выбираю текущую строку
	И в таблице 'Запасы' из выпадающего списка с именем 'ЗапасыНоменклатура' я выбираю по строке "$$Материал$$"
	И в таблице 'Запасы' я активизирую поле с именем 'ЗапасыКоличествоУпаковок'
	И в таблице 'Запасы' в поле с именем 'ЗапасыКоличествоУпаковок' я ввожу текст "1,000"
	И в таблице 'Запасы' я завершаю редактирование строки
...
Поступление запасов и услуг
	И в таблице 'Список' я выбираю текущую строку
	И я нажимаю на кнопку с именем 'КнопкаСоздатьНаОсновании_ПоступлениеЗапасовИУслуг'
	И я нажимаю на кнопку с именем 'ФормаКнопкаПровестиИЗакрыть'
Оприходование запасов
	...
	И я нажимаю на кнопку с именем 'КнопкаВыбрать'
	И в таблице 'Запасы' в поле с именем 'ЗапасыЦена' я ввожу текст "1000,00"
	И в таблице 'Запасы' я завершаю редактирование строки
	И я нажимаю на кнопку с именем 'ФормаКнопкаПровестиИЗакрыть'

...
Проверка отчетов
	...
	И я нажимаю на кнопку 'Конверсия первичных обращений:  Обращение -> Запись на приём -> Приём'
	И я нажимаю на гиперссылку с именем 'ПредставлениеПериода'
	И в поле с именем 'DateBegin' я ввожу текст "01.04.2025"
	И я нажимаю на кнопку с именем 'Select'
	И я нажимаю на кнопку с именем 'Button0'
	И я нажимаю на кнопку с именем 'Сформировать'
	И Я закрываю окно "Конверсия первичных обращений:  Обращение -> Запись на приём -> Приём"
	...
	И я нажимаю на кнопку 'Входящие звонки'
	И я нажимаю на гиперссылку с именем 'ПредставлениеПериода'
	И в поле с именем 'DateBegin' я ввожу текст "01.04.2025"
	И я нажимаю на кнопку с именем 'Select'
	И я нажимаю на кнопку с именем 'Button0'
	И я нажимаю на кнопку с именем 'Сформировать'
	И Я закрываю окно "Входящие звонки"
...
Сценарий: Оплата долга от врача
	...
	И в поле с именем 'Контрагент' я ввожу текст "$$ПациентВрача$$"

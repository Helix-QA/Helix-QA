...
Сценарий: Я определяю СЕ стоматологии
	И я выполняю код встроенного языка на сервере
		"""bsl
		ЗначениеСЕ = ПараметрыСеанса.ТекущаяСтруктурнаяЕдиница;
...
Сценарий: Я создаю Товар_3
	И Я запоминаю случайное число в переменную "Товар_3"
	Дано я запоминаю значение выражения '"Товар" + Формат($Товар_3$, "ЧГ=0")' в переменную "$$Товар_3$$"
	Дано Я открываю основную форму справочника "Номенклатура"
	И в поле с именем 'Наименование' я ввожу текст "$$Товар_3$$"
	И я нажимаю на кнопку с именем 'ДобавитьЦенуНоменклатуры'
	И я нажимаю на кнопку с именем 'Button0'
	И в поле с именем 'Цена' я ввожу текст "356,80"
	И в поле с именем 'Период' я ввожу текст "01.01.2000"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'		
	И я нажимаю на кнопку с именем 'ДобавитьЦенуНоменклатуры'
	...
	И в поле с именем 'Цена' я ввожу текст "214,30"
	И в поле с именем 'Период' я ввожу текст "01.01.2000"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
...
Сценарий: Я создаю даты
	...
	Дано Я запоминаю значение выражения 'Формат(ТекущаяДата(), "ДФ=ММММ*гг")' в переменную "$$МесяцГод$$"
...
Сценарий: Я создаю кабинет
	И я перехожу по навигационной ссылке "e1cib/data/Справочник.Помещения"
	И Я запоминаю случайное число в переменную "Кабинет_01"
	Дано я запоминаю значение выражения '"Кабинет" + Формат($Кабинет_01$, "ЧГ=0")' в переменную "$$Кабинет$$"
	И в поле с именем 'Наименование' я ввожу текст "$$Кабинет$$"

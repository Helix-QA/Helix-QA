...
Сценарий: 01. Создание условий для проверки	
	...
	Дано я открываю внешнюю обработку или отчет "D:\Helix\Helix-QA\tests\epf\_Universal_nyy_redaktor_rekvizitov_8_2_upravlyaemyy_interfeys_2.epf" (Расширение)	
...
Сценарий: 02. Проверка методов
	...
	Дано я открываю внешнюю обработку или отчет "D:\Helix\Helix-QA\tests\epf\Test_Api.epf" (Расширение)

...
Сценарий: Я проверяю XML_TaxationSystem
	...
	*Проверка чека
		И элемент формы с именем "XML" стал равен по шаблону:
			...
			| '<CheckPackage>'                                                                                                                                                                                                                                    |
			| '	<Parameters CashierName=\"*\" OperationType=\"1\" TaxationSystem=\"$СистемаНалогообложения$\" SaleLocation="Фитнес плюс " CustomerEmail=\"\" CustomerPhone=\"\" GroupingPositionsWhenPrinting=\"false\" OperationOnline="false">'                                                                    |
			| '		<AgentData/>'                                                                                                                                                                                                                                    |
			| '		<VendorData/>'                                                                                                                                                                                                                                   |
			| '		<CustomerDetail/>'                                                                                                                                                                                                                               |
...
Сценарий: Я проверяю XML_TaxationSystem (СПриоритетомНоменклатуры)
	...
	*Проверка чека
		И элемент формы с именем "XML" стал равен по шаблону:
			| '<?xml version=\"1.0\" encoding=\"UTF-8\"?>'                                                                                                                                                                                                                          |
			| '<CheckPackage>'                                                                                                                                                                                                                                                      |
			| '	<Parameters CashierName=\"*\" OperationType=\"1\" TaxationSystem=\"$СистемаНалогообложения2$\" SaleLocation="Фитнес плюс " CustomerEmail=\"\" CustomerPhone=\"\" GroupingPositionsWhenPrinting=\"false\" OperationOnline="false">'                                                                                                                        |
			| '		<AgentData/>'                                                                                                                                                                                                                                                      |
			| '		<VendorData/>'                                                                                                                                                                                                                                                     |
			| '		<CustomerDetail/>'                                                                                                                                                                                                                                                 |
			| '		<OperationalAttribute/>'                                                                                                                                                                                                                                           |
...
* Проверка xml
	И элемент формы с именем 'XML' стал равен по шаблону
		| '<?xml version=\"1.0\" encoding=\"UTF-8\"?>'                                                                                                                                                                                                                                       |
		| '<CheckPackage>'                                                                                                                                                                                                                                                                   |
		| '	<Parameters CashierName=\"*\" OperationType=\"1\" TaxationSystem=\"$TaxationSystem$\" SaleLocation="Фитнес плюс " CustomerEmail=\"\" CustomerPhone=\"\" GroupingPositionsWhenPrinting=\"false\" OperationOnline="false">'                                                                                                                                                                   |
		| '		<AgentData/>'                                                                                                                                                                                                                                                                   |
		| '		<VendorData/>'                                                                                                                                                                                                                                                                  |
		| '		<CustomerDetail/>'                                                                                                                                                                                                                                                              |
		| '		<OperationalAttribute/>'                                                                                                                                                                                                                                                        |
...
* Проверка xml
	И элемент формы с именем 'XML' стал равен по шаблону
		| '<?xml version=\"1.0\" encoding=\"UTF-8\"?>'                                                                                                                                                                                                                                       |
		| '<CheckPackage>'                                                                                                                                                                                                                                                                   |
		| '	<Parameters CashierName=\"*\" OperationType=\"2\" TaxationSystem=\"$TaxationSystem$\" SaleLocation="Фитнес плюс " CustomerEmail=\"\" CustomerPhone=\"\" GroupingPositionsWhenPrinting=\"false\" OperationOnline="false">'                                                                                                                                                               |
		| '		<AgentData/>'                                                                                                                                                                                                                                                                   |
		| '		<VendorData/>'                                                                                                                                                                                                                                                                  |
		| '		<CustomerDetail/>'                                                                                                                                                                                                                                                              |
		| '		<OperationalAttribute/>'                                                                                                                                                                                                                                                        |
...
Сценарий: Я проверяю XML
	...
	* Проверка xml
	Тогда элемент формы с именем 'XML' стал равен по шаблону:
		| '<?xml version=\"1.0\" encoding=\"UTF-8\"?>'                                                                                                                                                                                                                                                                                          |
		| '<CheckPackage>'                                                                                                                                                                                                                                                                                                                      |
		| '	<Parameters CashierName=\"*\" OperationType=\"*\" TaxationSystem=\"$TaxationSystem$\" SaleLocation="Фитнес плюс " CustomerEmail=\"\" CustomerPhone=\"\" GroupingPositionsWhenPrinting=\"false\" OperationOnline="false">'                                                                                                                                                                                                                      |
		| '		<AgentData/>'                                                                                                                                                                                                                                                                                                                      |
		| '		<VendorData/>'                                                                                                                                                                                                                                                                                                                     |
		| '		<CustomerDetail/>'                                                                                                                                                                                                                                                                                                                 |
		| '		<OperationalAttribute/>'                                                                                                                                                                                                                                                                                                           |

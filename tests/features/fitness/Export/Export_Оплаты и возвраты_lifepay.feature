...
Сценарий: Я создаю клиента lifepay
	...
	И в поле с именем 'Фамилия' я ввожу текст '$$КлиентLifePay$$'
	...
	И я сохраняю навигационную ссылку текущего окна в переменную "$$СсылкаКлиентаLifePay$$"		
...
//	И в поле с именем 'Контрагент' я ввожу текст '$$КлиентLifePay$$'

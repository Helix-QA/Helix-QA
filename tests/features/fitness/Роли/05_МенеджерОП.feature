...
//	И в поле с именем 'ПредставлениеКИ_3' я ввожу текст "Skype"
	...
	И я нажимаю на кнопку с именем 'КнопкаВыбрать'
	Если открылось окно "Рекламный источник" Тогда
		И в поле с именем 'ИсточникЗначение' я ввожу текст "Админ"
		И из выпадающего списка с именем 'ИсточникЗначение' я выбираю точное значение "Админ (Сотрудник)"

...
@ПакетУслугПродажаДоступнаКлиентам
...
@ПакетУслугНевозможноИспользоватьБезАктивногоЧленства
...
@ПакетУслугЗачислятьНаЛицевойСчет
...
@ПакетУслугВключенныеУслугиОпределяютсяПриПродаже

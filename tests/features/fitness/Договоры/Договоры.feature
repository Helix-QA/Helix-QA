...
Сценарий: Я заполняю Данными организацию и структурную единицу
	*Организация
		...
		И из выпадающего списка с именем 'ПредставлениеКИ_3' я выбираю точное значение "123, 123, 123"
		И из выпадающего списка с именем 'ПредставлениеКИ_4' я выбираю точное значение "123, 123, 123"

...
Сценарий: Я Проверяю на правильность и заполнения HTML шаблон
	...
	*Заполнение полей: префикс, номер, дата, членства, клиент.
		...
		И я жду, что в таблице "Список" количество строк будет "больше" 0 в течение 20 секунд
		И в таблице 'Список' я перехожу к строке:
			| "Активирован" | "Действует до"        | "Дней" | "Клиент"                   | "Менеджер продаж" | "Менеджер сервиса"        | "Номенклатура"      | "По порядку" | "Продано"             | "Продлено" | "Статус"  | "Статус продления" | "Стоимость" | "Сумма остаток" | "Услуг" |
			| "01.09.2025"  | "30.11.2025 23:59:59" | "90"   | "Станислав Стас Стасиевич" | "Админ"           | "Сотрудник Олег Игоревич" | "10 занятий в зале" | "1"          | "01.09.2025 15:37:33" | "Продлено" | "Активен" | "Новое"            | "100"       | "100"           | "10"    |
		И в таблице 'Список' я выбираю текущую строку				

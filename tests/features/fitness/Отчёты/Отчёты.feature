...
Сценарий: Покупка услуги групповые
	И я перехожу по навигационной ссылке "$$СсылкаКлиента_2$$"
	И В текущем окне я нажимаю кнопку командного интерфейса "Продажи"
	И я нажимаю на кнопку с именем 'Создать'
	И я активизирую дополнение формы с именем 'ДополнениеСтрокаПоиска'
...
Сценарий: Поступление на счёт
	...
	И в поле с именем 'СуммаДокумента' я ввожу текст "1000,00"
...
Сценарий: Взнос на лицевой счёт
	...
	И я нажимаю на кнопку с именем 'КассаОплаты_1'
	И я нажимаю на кнопку с именем 'КнопкаВидыОплатаНаименованиеСтрока_0'
	И в поле с именем 'ПолеВидыОплатВводСуммыСтрока_0' я ввожу текст "1000,00"
	И я нажимаю на кнопку с именем 'Оплатить'
...
Сценарий: Производится Списание денежных средств
	...
	И в поле с именем 'Касса' я ввожу текст "Проверка отчётов"
	И из выпадающего списка с именем 'Касса' я выбираю "Проверка отчётов"
	И я нажимаю на кнопку с именем 'ЗатратыКнопкаДобавить'
	И в таблице 'Затраты' я активизирую поле с именем 'ЗатратыСтатьяЗатрат'
	И в таблице 'Затраты' я нажимаю кнопку выбора у реквизита с именем 'ЗатратыСтатьяЗатрат'
	И в таблице 'Список' я перехожу к строке:
		| "Наименование" |
		| "Материалы"    |
	И в таблице 'Список' я выбираю текущую строку
	И в таблице 'Затраты' я завершаю редактирование строки
	И в поле с именем 'СуммаДокумента' я ввожу текст "100,00"
	И я нажимаю на кнопку с именем 'КнопкаЗаписать'
	И я нажимаю на кнопку с именем 'ФормаПровести'

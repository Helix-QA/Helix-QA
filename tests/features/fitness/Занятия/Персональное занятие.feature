...
//Создание занятия.
	...
	И я перехожу к следующему реквизиту
	И таблица 'Список' содержит строки по шаблону:
		| 'Регистратор'              | 'Занятие'                                                 | 'Услуга, сегмент'                                                | 'Количество' | 'Сумма'  | 'Сумма без скидки' |
...
//Создание занятия+смена данных после его проведения.	
	...
	И таблица 'Список' содержит строки по шаблону:
		| 'Сотрудник'   | 'Регистратор'                                                        | 'Занятие'                                                                                                | 'Услуга, сегмент'                                                    |
		| '$$Тренер2$$' | 'Запись на занятие * от $$Сегодня$$ $$СегодняДляЗанятияБезНуля$$:00' | 'Персональное: $$Сегодня$$ $$СегодняДляЗанятия1$$, $$УслугаПерсональная_2$$, Фитнес плюс, * (выполнено)' | '$$УслугаПерсональная_2$$, $$УслугаПерсональная_2$$, Розничная цена' |

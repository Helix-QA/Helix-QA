...
Сценарий: Я создаю клиента для объединения
	*Создание 1 клиента
		...
		И в поле с именем 'Фамилия' я ввожу текст "Клиент объединения"
	...
	*Создание 2 клиента
		...
		И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
		И я нажимаю на кнопку с именем 'ДобавитьМедСправка'
		И я нажимаю кнопку выбора у поля с именем 'МедСправка'
		И я нажимаю на кнопку с именем 'Создать'
		И в поле с именем 'Наименование' я ввожу текст "123123123123123123123"
		И в поле с именем 'СрокДействия' я ввожу текст "11"
		И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
		И в таблице 'Список' я выбираю текущую строку
		И я нажимаю на кнопку с именем 'СохранитьДокументПостоянная'				
		И я нажимаю на кнопку с именем 'Записать'
	...
	*Проверка клиента на объединение
		...
		И у элемента формы с именем 'ДатаРожденияВсплывающая' текст редактирования стал равен "  .  .    "
		И элемент формы с именем 'ДействиеКИ_0' стал равен "ДействиеКИ_0"
		...
		И элемент формы с именем 'ДекорацияАктуальностьДанныхПоПакетуУслуг' стал равен " * - Данные не актуальны"
		И элемент формы с именем 'ДекорацияАктуальностьДанныхПоЧленству' стал равен " * - Данные не актуальны"
		И элемент формы с именем 'ДекорацияБлокировкаОнлайнЗаписи' стал равен "ДекорацияБлокировкаОнлайнЗаписи"
		И элемент формы с именем 'ДекорацияВероятностьПродленияПакетаУслугНадпись' стал равен "- продление пакета"
		И элемент формы с именем 'ДекорацияВероятностьПродленияЧленстваНадпись' стал равен "- продление членства"
		И элемент формы с именем 'ДекорацияВзаимодействиеЗадачаДата' стал равен "Декорация взаимодействие задача дата"
		И элемент формы с именем 'ДекорацияВзаимодействиеЗадачаЗаголовок' стал равен "Взаимодействие"
		И элемент формы с именем 'ДекорацияВзаимодействиеЗадачаИконка' стал равен "Декорация взаимодействие задача иконка"
		И элемент формы с именем 'ДекорацияВзаимодействиеЗадачаСтатусВыполненияЗаглушка' стал равен "ДекорацияВзаимодействиеЗадачаСтатусВыполненияЗаглушка"
		...
		И элемент формы с именем 'ДекорацияЗаглушкаОплатить' стал равен "Задолженности"
		И элемент формы с именем 'ДекорацияЗаголовокРейтингПоПакетуУслуг' стал равен "Рейтинг по пакету"
		И элемент формы с именем 'ДекорацияЗаголовокРейтингПоЧленству' стал равен "Рейтинг по членству"
		И элемент формы с именем 'ДекорацияЗаголовокСЕ' стал равен "Структурная единица:"
		И элемент формы с именем 'ДекорацияКонтакты' стал равен "Контакты"
		И элемент формы с именем 'ДекорацияКорпоративныеДоговорыЗаголвок' стал равен "Корпоративные договоры"
		И элемент формы с именем 'ДекорацияКредитныеДоговорыЗаголвок' стал равен "Кредитные договоры"
		И элемент формы с именем 'ДекорацияЛичныйКабинет' стал равен "Личный кабинет"
		И элемент формы с именем 'ДекорацияМаркетингСтрокаОтступ' стал равен "ДекорацияМаркетингСтрокаОтступ"
		И элемент формы с именем 'ДекорацияМенеджерыВыбранные' стал равен "Декорация менеджеры выбранные"
		И элемент формы с именем 'ДекорацияМенеджерыСтрокаОтступ' стал равен "ДекорацияМенеджерыСтрокаОтступ"
		И элемент формы с именем 'ДекорацияОписаниеДавностьПакетаУслуг' стал равен "Давность (тренировался вчера)"
		И элемент формы с именем 'ДекорацияОписаниеДавностьЧленства' стал равен "Давность (был вчера)"
		И элемент формы с именем 'ДекорацияОписаниеСтажПакетаУслуг' стал равен "Стаж (258 занятий)"
		И элемент формы с именем 'ДекорацияОписаниеСтажЧленства' стал равен "Стаж (258 дней)"
		И элемент формы с именем 'ДекорацияОписаниеЧастотаПакетаУслуг' стал равен "Частота (2 занятия в месяц)"
		И элемент формы с именем 'ДекорацияОписаниеЧастотаЧленства' стал равен "Частота (2 посещения в месяц)"
		И элемент формы с именем 'ДекорацияПоследнееПосещение' стал равен "ДекорацияПоследнееПосещение"
		И элемент формы с именем 'ДекорацияПредставлениеАвтомобиль' стал равен "Автомобили"
		И элемент формы с именем 'ДекорацияПредставлениеДокументПостоянная' стал равен "Удостоверения личности"
		И элемент формы с именем 'ДекорацияПредставлениеКарта' стал равен "Карты"
		И элемент формы с именем 'ДекорацияПредставлениеМаркетинг' стал равен "Маркетинг"
		И элемент формы с именем 'ДекорацияПредставлениеМедСправка' стал равен "Мед. справки"
		И элемент формы с именем 'ДекорацияПредставлениеМенеджеры' стал равен "Персональные менеджеры"
		И элемент формы с именем 'ДекорацияПредставлениеПлатежнаяКарта' стал равен "Платежные карты"
		И элемент формы с именем 'ДекорацияПредставлениеПромокод' стал равен "Реферальные коды"
		И элемент формы с именем 'ДекорацияПредставлениеРодственник' стал равен "Родственники"
		И элемент формы с именем 'ДекорацияРекуррентныеДоговораЗаголвок' стал равен "Рекуррентные договоры"
		И элемент формы с именем 'ДекорацияСоДоступШапка' стал равен "Содоступ"
		И элемент формы с именем 'ДекорацияСтатусЗаглушка' стал равен "ДекорацияСтатусЗаглушка"
		И элемент формы с именем 'ДекорацияСтатусы' стал равен "История статусов клиента"
		И элемент формы с именем 'ДекорацияУдалениеОнлайнБлокировки' стал равен "Декорация удаление онлайн блокировки"
		...
		И элемент формы с именем 'КартыСуществующие_0' стал равен "Карта №2000000000060"
		И элемент формы с именем 'Комментарий' стал равен ""
		И элемент формы с именем 'КомментарийКИ_0' стал равен ""
		И элемент формы с именем 'Лицевой_Бонусный_Счет_Контрагента_0' стал равен "БонусныйСчет1422946072 (Общий расход: 0,00 ₽) "
		И элемент формы с именем 'Лицевой_Бонусный_Счет_Контрагента_1' стал равен "БонусныйСчет1422946072 (Общий расход: 0,00 ₽) "
		И элемент формы с именем 'Лицевой_Бонусный_Счет_Контрагента_Заглушка_0' стал равен "Лицевой_Бонусный_Счет_Контрагента_Заглушка_0"
		И элемент формы с именем 'Лицевой_Бонусный_Счет_Контрагента_Заглушка_1' стал равен "Лицевой_Бонусный_Счет_Контрагента_Заглушка_1"
		И элемент формы с именем 'МедСправкиЗаглушка_0' стал равен "МедСправкиЗаглушка_0"
		И элемент формы с именем 'МедСправкиСуществующие_0' стал равен "123123123123123123123, выдана 09.09.2025 до 09.08.2026"
		И элемент формы с именем 'НадписьРастягивания_0' стал равен "НадписьРастягивания_0"
		И элемент формы с именем 'НоваяЗаметка' стал равен ""
		И элемент формы с именем 'Отчество' стал равен ""
		И элемент формы с именем 'ОтчествоВсплывающее' стал равен ""
		И элемент формы с именем 'ПоказатьФИОВсплывающее' стал равен "Клиент Объединения, 25 лет"
		И элемент формы с именем 'Пол' стал равен "Мужской"
		И элемент формы с именем 'ПолВсплывающая' стал равен ""
		И элемент формы с именем 'ПолеДобавить_ME_МенюИнтересы_Тип_ПолеВвода' стал равен ""
		И элемент формы с именем 'ПолеДобавить_ME_МенюТеги_Тип_ПолеВвода' стал равен ""
		...
		И элемент формы с именем 'ПредставлениеКИ_0' стал равен ""
		И элемент формы с именем 'РазрешитьЗапретитьРассылку_0' стал равен "РазрешитьЗапретитьРассылку_0"
		...
		И элемент формы с именем 'Фамилия' стал равен "Клиент Объединения"
		И элемент формы с именем 'ФамилияВсплывающая' стал равен "Клиент Объединения"				
		И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

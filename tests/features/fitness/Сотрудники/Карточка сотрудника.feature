...
*Контакты
	//И в поле 'КонтактнаяИнформацияПолеf0a14f2cx23fax11f0xbbe0x0050568bbe811' я ввожу текст "077812345"
	//И в поле 'КонтактнаяИнформацияПолеf0a14f2bx23fax11f0xbbe0x0050568bbe811' я ввожу текст "Тирасполь"
	//И в поле 'КонтактнаяИнформацияПолеf0a14f29x23fax11f0xbbe0x0050568bbe811' я ввожу текст "Daniil@mail.ru"
...
*По дням недели		
	...
	И я нажимаю на кнопку с именем 'КомандаЕще'
	И из выпадающего списка с именем 'День_3' я выбираю точное значение "Пятница"
	И я нажимаю на кнопку с именем 'Кнопка1'	
...
*Загрузка файлов
	И В текущем окне я нажимаю кнопку командного интерфейса "Файлы"		
	И я выбираю файл 'C:\GitHab\Helix-QA\tests\features\fitness\Сотрудники\Фото2.png'

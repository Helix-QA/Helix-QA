...
=======
		Дано я открываю внешнюю обработку или отчет "C:\VA_test\Test_Api.epf" (Расширение)
>>>>>>> 92ec086700a28961299023c542f29cf09824d5d5
...
<<<<<<< HEAD
		Дано я открываю внешнюю обработку или отчет "$КатологПроекта$\epf\Test_Api.epf" (Расширение)
=======
		Дано я открываю внешнюю обработку или отчет "C:\VA_test\epf\Test_Api.epf" (Расширение)
>>>>>>> 92ec086700a28961299023c542f29cf09824d5d5
		И я нажимаю на кнопку с именем 'Api_v3'
		И я нажимаю на кнопку с именем 'ТипЗапроса'
		И я выбираю из списка 'POST'

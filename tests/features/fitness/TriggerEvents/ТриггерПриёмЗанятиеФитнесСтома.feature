...
Сценарий: Проверка конфигурации и создание триггеров для фитнеса и стоматологии.
	Если переменная "ИмяКонфигурации" имеет значение "ФитнесКлуб_КОРП" Тогда
...
//Добавление второго клиента в лист ожидания занятия.
		Дано я открываю внешнюю обработку или отчет "D:\Моя документация(данные)\Обработки\Test_Api_Fitness4.epf" (Расширение)
		...
		И в таблице 'Список' я перехожу к строке:
			| "Ключ приложения"                      | "Наименование"                                       | "Тип внешней системы" |
			| "dae7f345-5902-4f3a-a244-b7b7f9290817" | "Виджет расписания-dae7f345-5902-4f3a-a244-b7b7f929" | "Виджет расписания"   |
...
//Активация триггера - 	Получена оценка приёма.
		И Я закрываю окно "Исходные данные чека"
		Дано я открываю основную форму регистра сведений "ОценкиПриемов"

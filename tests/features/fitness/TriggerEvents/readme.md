...
1. <a id="title1">Описание фичи - ТриггерБонусныеСчетаФитнес.</a>Описание работы Описание работы триггеров в Фитнес клубе.
-  В данном фича файле проверяются следующие события: Начисление на бонусный счет, Окончание срока действия бонусного счета, Окончание срока действия начисления на бонусный счет, Списание с бонусного счета.